...
# private methods are only accessible from other methods in the class (or subclass)
# in Ruby, private methods can also be inherited just like protected and public methods