...
class Human < Player
  def choose_name
    ...
    loop do
      ...
      break unless unvalid_name?(choice)
      puts "Invalid input!"
    end
    self.name = choice
  end

  def unvalid_name?(choice)
...
class TTTGame
  ...
  attr_accessor :beginning_marker
  ...
  def pick_beginning_player
    ...
    beginning_player(choice)
    display_beginning_player
  end

  def beginning_player(choice)
    @beginning_marker = if VALID_P.include?(choice)
                          human.marker
    ...
    @current_marker = @beginning_marker
  end
  ...
  def switch_beginner
    @beginning_marker = if beginning_marker == human.marker
                          Board::COMPUTER_MARKER
                        else
                          human.marker
                        end
