...
class TTTGame
  ...
  def computer_moves
    if board.immediate_move?(COMPUTER_MARKER)
      board[board.move(COMPUTER_MARKER)] = computer.marker
    elsif board.immediate_move?(HUMAN_MARKER)
      board[board.move(HUMAN_MARKER)] = computer.marker
    else
