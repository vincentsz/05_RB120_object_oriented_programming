...
class Computer < Player
  ...
  def set_personality
    self.personality = case name
                       when 'Hal' then pers_generator([4, 8, 15, 3, 5])
                       when 'C3PO' then pers_generator([0, 0, 0, 0, 1])
                       when 'R2D2' then pers_generator([1, 2, 3, 4, 2])
                       when 'Marvin' then pers_generator([2, 2, 2, 2, 2])
                       when 'Kitt' then pers_generator([10, 3, 5, 3, 7])
                       when 'Wall-E' then pers_generator([5, 3, 10, 3, 5])
                       end
  end
