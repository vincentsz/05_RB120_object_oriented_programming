...
# -------- Classes ----------
class Choice
  attr_accessor :value, :name, :winners
  ...
  def initialize(value)
    if value == 'rock'
      ...
      @value = Paper.new(value)
    elsif value == 'scissors'
      @value = Scissors.new(value)
    elsif value == 'lizard'
      @value = Lizard.new(value)
    elsif value == 'spock'
      @value = Spock.new(value)
    end
  end
  
  def <(other)
    value.winners.include?(other.value.name)
  end
